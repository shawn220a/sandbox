// let locationSearch = []; // This will be the array of our log locations
// let userSearch = []; // This will be the array of our usernames

// $(function() {
//   $("#mapid").on("click", function (event) {
...
$(function() {
  ...
  $("#newEntry").on("submit", function(event) {
    ...
    const newLoc = $("#attractionLocation").val().trim();
    const newLocale = geo(newLoc);

    var newEntry = {
      location: $("#attractionName").val().trim(),
      journal_entry: $("#attractionDescription").val().trim(),
      latitude: $(newLocale.lat),
      longitude: $(newLocale.lng)
    };
...
// This makes the collapsible blocks
